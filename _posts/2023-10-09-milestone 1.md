...
plt.show()
```
![Alt text](/assets/shot_types.png)
...
plt.show()
```
![Alt text](/assets/missed_shots.png)
...
plt.show()
```
![Alt text](/assets/goals_scored.png)
...
plt.show()
```
![Alt text](/assets/shots_and_goals.png)
...
```
![Alt text](/assets/goal_to_shot_ratio.png)
As shown in the bar graph the most dangerous type of shot is the "Deflected" shot type. 

### Question 2. relationship between the distance a shot was taken and the chance it was a goal
...
![Alt text](/assets/processed_dataframe.png)
...
plt.show()
```
![Alt text](/assets/season_2020_2021.png)
...
plt.show()
```
![Alt text](/assets/season_2019_2020.png)
...
plt.show()
```
![Alt text](/assets/season_2018_2019.png)
...
![Alt text](/assets/dataframe_q3.png)
...
plt.show()
```
![Alt text](/assets/observation.png)
